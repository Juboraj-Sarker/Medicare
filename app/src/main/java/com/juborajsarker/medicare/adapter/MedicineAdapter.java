...
import com.juborajsarker.medicare.activity.medicines.EditMedicineActivity;
import com.juborajsarker.medicare.broadcastReceiver.AlarmReceiver;
import com.juborajsarker.medicare.database.AlarmDatabase;
import com.juborajsarker.medicare.database.MedicineDatabase;
import com.juborajsarker.medicare.dataparser.ImageSaver;
import com.juborajsarker.medicare.model.AlarmModel;
...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_medicine, parent, false);
